...
const Hero = () => (
  <header className="min-h-54 flex flex-col items-center justify-center gap-4 mb-10">
    <span className="text-black/80 text-[10px] sm:text-xs bg-stone-200 px-3 py-1 rounded-xl">
      {HERO.preface}
    </span>
    <h1 className="text-3xl md:text-4xl font-bold font-oswald capitalize tracking-tight text-balance my-1">
